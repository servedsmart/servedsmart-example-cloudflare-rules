    ...
    cat <<EOF
{
  ...
  "description": "Generated by https://github.com/servedsmart/servedsmart-example-http-headers",
  "kind": "zone",
  ...
  "rules": [
    ...
    {
      "expression": "(http.request.uri.path wildcard r\"/*/edit-cms/*\") or (starts_with(http.request.uri.path, \"/edit-cms\"))",
...
API_LIST_RULESETS="$(curl https://api.cloudflare.com/client/v4/zones/"${CLOUDFLARE_ZONE_ID}"/rulesets -X GET -H "Authorization: Bearer ${CLOUDFLARE_API_TOKEN}")"
